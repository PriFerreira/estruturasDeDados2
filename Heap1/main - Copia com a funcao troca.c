...
void troca(int pai, int filhoEscolhido, int* v) {
	int aux = v[pai];
	v[pai] = v[filhoEscolhido];
	v[filhoEscolhido] = aux;
} 
...
void corrigeHeap(HEAP* heap){
	...
	/*	printf("\nindice atual: %d\n", indice);
		...
		printf("filho esq: %d\n", filhoEsquerda);
		printf("filho dir: %d\n", filhoDireita);
		printf("valor pai atual: %d\n", heap->valor[indice]);
		printf("valor em esq atual: %d\n", heap->valor[filhoEsquerda]);
		printf("valor em dir: %d\n", heap->valor[filhoDireita]);*/
		
		printf("\nto na correcao...\n");
		
		//if (filhoDireita >= heap->tamanhoAtual) filhoDireita = filhoEsquerda;
		
		if (heap->valor[filhoEsquerda] > heap->valor[filhoDireita]){
			filhoEscolhido = filhoEsquerda;
		//	printf("\n o valor da esquerda eh maior q da dire");
		}else{
			filhoEscolhido = filhoDireita;	
		//	printf("\n o valor da esquerda eh maior q da dire");
		}
			
	//	printf("\npai atual: %d\n", heap->valor[pai]);
//		printf("filho escolhido: %d\n", heap->valor[filhoEscolhido]);
			
		if (heap->valor[pai] < heap->valor[filhoEscolhido]){
			
		    printf("\nbora trocar...\n");
			troca(pai, filhoEscolhido, heap->valor);				
...
main(){
  ...
  //Chama a construção do Heap, neste caso o máximo
